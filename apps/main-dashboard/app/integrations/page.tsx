    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Connect Anti-Monitor to your favorite frameworks
        </p>
      </div>
                ...
                <div className="flex flex-col h-full">
                  <div
                    className={`h-12 w-12 rounded-lg border border-white/5 ${
                      integration.name === 'Remix' || integration.name === 'Django'
                        ? 'bg-black/90'
                        : 'bg-white'
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm font-semibold text-white mb-0.5">{integration.name}</h3>
                    <p className="text-xs text-white/40 leading-tight">Coming soon</p>
                  </div>
                </div>
              </div>
            </div>
