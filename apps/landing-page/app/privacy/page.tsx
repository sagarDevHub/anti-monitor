...
export const metadata = makePageMetadata({
  ...
  description: 'How Anti-Monitor collects, uses, and protects your information.',
  path: '/privacy',
});
        ...
        <div className="md:w-[71%] w-[90%] mx-auto py-10 space-y-8">
          ...
          <header className="space-y-2">
            ...
            <p className="text-white/60!">
              How Anti-Monitor collects, uses, shares, and protects your information.
            </p>
          ...
          <section className="px-3 space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                This policy covers personal information we process when you use Anti-Monitor,
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-5 text-sm text-white/70! space-y-1">
                <li>
                  Account data: name, email, authentication profile, plan and billing metadata.
                </li>
                <li>
                  Product usage: requests, performance metrics, device/browser, timestamps, region.
                </li>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                ...
                delete, port, or restrict processing of your personal data. We honor opt‑out
                requests for marketing communications and support regional privacy requirements.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                We use cookies and similar technologies for session authentication, preferences, and
                usage analytics. You can manage cookies in your browser settings; blocking some
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                ...
                You can delete logs or request account deletion through the dashboard or API at any
                time.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                We protect data in transit and at rest using industry‑standard controls. Access to
                systems is restricted and audited. No method is 100% secure—please keep your API
                keys confidential and rotate them regularly.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                We do not sell personal information. We may share limited data with trusted
                providers (hosting, email, analytics) solely to deliver the service, subject to
                agreements and safeguards. Data may be processed in regions outside your locale with
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                When transferring data across borders, we implement measures consistent with
                applicable laws, including contractual protections and technical safeguards.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                ...
                their personal data. If you believe a child has provided data to us, contact support
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                This Privacy Policy is governed by the laws of the United States of America. Where
                relevant, applicable state laws may also apply.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-white/70!">
                We may update this policy as the product evolves. If material changes occur, we will
                notify you within the product or on our site. Continued use indicates acceptance of
                the updated policy.
              </p>
            </div>
          </section>
