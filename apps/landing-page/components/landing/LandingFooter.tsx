      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex gap-8 text-xs text-slate-500">
            ...
            <Link
              href="https://github.com/sagarDevHub/anti-monitor"
              target="_blank"
              className="hover:text-slate-300 transition-colors"
            >
              GitHub
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  <span className="text-xs text-slate-500">All systems are operational now</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent>
                <p>Live</p>
        ...
        <div className="mt-8 border-t border-slate-900 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[0.7rem] text-slate-600">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
            <div>© {currentYear} Anit-Monitor Stack Inc.</div>
            <div className="hidden sm:block text-slate-800">•</div>
            <div className="flex items-center gap-1">
              Built with <span className="text-red-500 mx-1">❤️</span> for developers
            </div>
          </div>
