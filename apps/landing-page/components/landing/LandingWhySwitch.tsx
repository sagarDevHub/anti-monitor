      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="max-w-2xl mb-10">
          <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight text-slate-50">
            Why developers switch to Anti-Monitor.
          </h2>
          <p className="mt-3 text-sm sm:text-base text-slate-300">
            See at a glance how life looks before and after you plug in Anti-Monitor.
          </p>
        </div>
          ...
          <div className="rounded-2xl border border-sky-500/30 bg-slate-950/90 p-6 sm:p-7 shadow-[0_0_20px_-5px_rgba(56,189,248,0.18)] hover:shadow-[0_0_30px_-5px_rgba(56,189,248,0.3)] hover:border-sky-500/50 transition-all duration-300">
            ...
            <ul className="space-y-3 text-sm text-slate-200">
              {[
                ...
                {
                  icon: FileJson,
                  text: `No complicated setup, store logs with just few lines of code.`,
                },
                {
                  icon: BadgeDollarSign,
                  text: 'Simple pricing that grows with your app, not your stress.',
                },
                {
                  icon: LayoutDashboard,
                  text: 'Get your log access in your dashboard with our SDK.',
                },
