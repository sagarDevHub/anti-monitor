...
import { Package, MousePointerClick, Monitor, Sparkles, Terminal } from 'lucide-react';
...
const steps = [
  {
    ...
    icon: Package,
    code: `npm install @antimonitor/next
# or
npm install @antimonitor/express`,
    language: 'bash',
  },
  {
    id: 2,
    ...
    code: `import { createLogger } from "@antimonitor/next";
...
`,
  ...
  },
  {
    ...
    icon: Sparkles,
    code: `// Visit antimonitor.com/dashboard/live-logs
...
export function LandingSetup() {
  ...
  return (
    <section className="border-b border-slate-900/80 bg-slate-950/60" id="integrations">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-4 text-base text-slate-400">
            You don&apos;t need to learn a new system. Just drop in the SDK and start seeing logs
            immediately.
          </p>
        </div>
