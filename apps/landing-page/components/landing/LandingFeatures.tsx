        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          >
            ...
            <div className="space-y-5 text-sm sm:text-base text-slate-300 leading-relaxed">
              <p>
                Most devs don&apos;t have time to babysit a logging stack. ELK, random dashboards,
                YAML jungles — all just to answer one question:{' '}
                <span className="text-slate-100 font-medium">What went wrong?</span>
              </p>
              <p>
                If you&apos;re shipping fast — junior, indie, side-project, or a small team — you
                don&apos;t want to spend days wiring logs. You just want errors, requests, and
                latency in one place, instantly.
              </p>
              <p>Anti-Monitor removes all the overhead.</p>
              <p>
                Drop in a small SDK, deploy, and your logs start streaming in under a minute. No
                servers. No cluster tuning. No 40-page docs before anything works.
              </p>
              <p>
                It’s logging that just works, instead of becoming another system you have to
                maintain.
              </p>
            </div>
          </motion.div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 space-y-10">
          ...
          >
            ...
            <p className="max-w-md text-sm sm:text-base text-slate-300">
              Simple tools that help you see what your app is doing, without learning a new system.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              <div className="p-6 sm:p-8">
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  Send JSON logs from your app, API, or background jobs without schemas or
                  migrations. We index everything automatically so you can focus on shipping.
                </p>
              </div>
            </motion.article>
            ...
            >
              <div className="p-6 sm:p-8">
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  ...
                  . Watch events stream in real-time with Live Tail to see exactly what&apos;s
                  happening.
                </p>
              </div>
            </motion.article>
            ...
            >
              <div className="p-6 sm:p-8">
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  Get a live stream of your log data directly in your application. Build your own
                  custom dashboard views without needing to visit our website to check your logs.
                </p>
              </div>
            </motion.article>
            ...
            >
              <div className="p-6 sm:p-8">
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  Never miss a critical error. Set up alerts for specific events and receive instant
                  notifications via webhooks. Track application crashes before they happen.
                </p>
              </div>
            </motion.article>
          </motion.div>
